    ...
    <area xsi:type="esdl:Area" id="RotterdamHIC_area" name="RotterdamHIC" sector="REF">
      ...
      <area xsi:type="esdl:Area" id="IndoramaEURA_area" name="Indorama_EurA">
        ...
        <asset xsi:type="esdl:Building" name="Indorama_EurA" id="IndoramaEURA_building" sector="NONCHLO">
          ...
          <asset xsi:type="esdl:CHP" CHPType="UNDEFINED" assetType="Cogen" power="91.0" efficiency="1.0" electricalEfficiency="0.31" heatEfficiency="0.49" name="IndoramaEURA" controlStrategy="fabbda27-9a46-4536-8283-4640da3750b3" id="C14" sector="NONCHLO">
            <costInformation xsi:type="esdl:CostInformation">
      ...
      <area xsi:type="esdl:Area" id="ADMEURA_area" name="ADM_EurA">
        ...
        <asset xsi:type="esdl:Building" name="ADM_EurA" id="ADMEURA_building" sector="EDOIL">
          ...
          <asset xsi:type="esdl:CHP" CHPType="STEG" assetType="Cogen" power="70.0" efficiency="1.0" electricalEfficiency="0.31" heatEfficiency="0.49" name="ADMEURA" controlStrategy="a19ba7e3-7014-4664-95c1-83a067d285a8" id="C15" sector="EDOIL">
            <costInformation xsi:type="esdl:CostInformation">
      ...
      <area xsi:type="esdl:Area" id="AlcoEURC_area" name="AlcoEnergy_EurC">
        ...
        <asset xsi:type="esdl:Building" name="AlcoEnergy_EurC" id="AlcoEURC_building" sector="CHEMFEED">
          ...
          <asset xsi:type="esdl:CHP" CHPType="GAS_MOTOR" assetType="Cogen" power="150.0" efficiency="1.0" electricalEfficiency="0.31" heatEfficiency="0.49" name="AlcoEURC" controlStrategy="495b144d-7317-4bb3-8420-61d8d22f73a1" id="C23" sector="CHEMFEED">
            <costInformation xsi:type="esdl:CostInformation">
      ...
      <area xsi:type="esdl:Area" id="ShellPER_area" name="Shell_PER">
        ...
        <asset xsi:type="esdl:Building" name="Shell_PER" id="ShellPER_building" sector="REF">
          ...
          <asset xsi:type="esdl:CHP" CHPType="GAS_TURBINE" assetType="Cogen" power="699.0" efficiency="1.0" electricalEfficiency="0.33" heatEfficiency="0.62" name="ShellPER" controlStrategy="a0b633b7-6101-4131-9994-7ca3cc7f7718" id="C63" sector="REF">
            <costInformation xsi:type="esdl:CostInformation">
